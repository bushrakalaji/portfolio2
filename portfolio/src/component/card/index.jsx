...
function Card({ card: { acf } }) {
  const title = acf && acf.title;
  const description = acf && acf.description;
  const image = acf && acf.image;
  const css = acf && acf.css;
  const bootstrap = acf && acf.bootstrap;
  const js = acf && acf.js_;
  const react = acf && acf.react;
  const scss = acf && acf.scss;
  const githubUrl = acf && acf.github;
  const liveDemo = acf && acf.live;
